...
namespace Nikse.SubtitleEdit.Forms
{
    sealed partial class Main
    {
        ...
        private void InitializeComponent()
        {
			...
			// tabPageCreate
			// 
			this.tabPageCreate.Controls.Add(this.comboBoxActors);
			...
			// comboBoxActors
			// 
			this.comboBoxActors.DropDownStyle = System.Windows.Forms.ComboBoxStyle.DropDownList;
			this.comboBoxActors.FormattingEnabled = true;
			this.comboBoxActors.Location = new System.Drawing.Point(67, 221);
			this.comboBoxActors.MaxDropDownItems = 99;
			this.comboBoxActors.Name = "comboBoxActors";
			this.comboBoxActors.Size = new System.Drawing.Size(136, 21);
			this.comboBoxActors.TabIndex = 68;
			// 
			// Main
			// 
